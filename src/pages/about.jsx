    ...
    return (
        ...
        <div class="about_institution">
            ...
            <div class="about_logos">
                ...
                <div class="logo">
                    <img src="/kpr_group.png"/>
                    <p>KPR Group of Company</p>
                </div>
                <div class="logo">
                    <img src="../public/kprcas.png"/>
                    <p>KPRCAS Institutions</p>
                </div>
                <div class="logo">
                    <img src="../public/audi.png"/>
                    <p>Audi Showroom</p>
                </div>
                <div class="logo">
                    <img src="../public/kpr_ias.png"/>
                    <p>KPRIAS Academy</p>
                </div>
                <div class="logo">
                    <img src="../public/kpriet.png"/>
                    <p>KPRIET Institutions</p>
                </div>
                <div class="logo">
                    <img src="../public/sugar_mill.png"/>
                    <p>KPR Sugar Mill Limited</p>
                </div>
                <div class="logo">
                    <img src="../public/faso.png"/>
                    <p>KPR Faso Mens wear</p>
                </div>
            </div>
        </div>
        <hr/>
        <div class="about_spark">
